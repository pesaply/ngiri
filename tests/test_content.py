...
async def test_empty_content():
    request = ngiri.Request(method, url)
...
async def test_bytes_content():
    request = ngiri.Request(method, url, content=b"Hello, world!")
    ...
    with pytest.warns(DeprecationWarning):
        request = ngiri.Request(method, url, data=b"Hello, world!")  # type: ignore
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_bytesio_content():
    request = ngiri.Request(method, url, content=io.BytesIO(b"Hello, world!"))
    assert isinstance(request.stream, typing.Iterable)
...
async def test_async_bytesio_content():
    ...
    request = ngiri.Request(method, url, content=AsyncBytesIO(b"Hello, world!"))
...
async def test_iterator_content():
    ...
    request = ngiri.Request(method, url, content=hello_world())
    assert isinstance(request.stream, typing.Iterable)
    assert not isinstance(request.stream, typing.AsyncIterable)
    ...
    # Support 'data' for compat with requests.
    with pytest.warns(DeprecationWarning):
        request = ngiri.Request(method, url, data=hello_world())  # type: ignore
    assert isinstance(request.stream, typing.Iterable)
    assert not isinstance(request.stream, typing.AsyncIterable)
...
async def test_json_content():
    request = ngiri.Request(method, url, json={"Hello": "world!"})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_urlencoded_content():
    request = ngiri.Request(method, url, data={"Hello": "world!"})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_urlencoded_boolean():
    request = ngiri.Request(method, url, data={"example": True})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_urlencoded_none():
    request = ngiri.Request(method, url, data={"example": None})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_urlencoded_list():
    request = ngiri.Request(method, url, data={"example": ["a", 1, True]})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_multipart_data_and_files_content():
    ...
    files = {"file": io.BytesIO(b"<file content>")}
    headers = {"Content-Type": "multipart/form-data; boundary=+++"}
    request = ngiri.Request(method, url, data=data, files=files, headers=headers)
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_empty_request():
    request = ngiri.Request(method, url, data={}, files={})
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
def test_invalid_argument():
    with pytest.raises(TypeError):
        ngiri.Request(method, url, content=123)  # type: ignore

    with pytest.raises(TypeError):
        ngiri.Request(method, url, content={"a": "b"})  # type: ignore
...
async def test_multipart_multiple_files_single_input_content():
    ...
    headers = {"Content-Type": "multipart/form-data; boundary=+++"}
    request = ngiri.Request(method, url, files=files, headers=headers)
    assert isinstance(request.stream, typing.Iterable)
    assert isinstance(request.stream, typing.AsyncIterable)
...
async def test_response_iterator_content():
    ...
    response = ngiri.Response(200, content=hello_world())
    assert isinstance(response.stream, typing.Iterable)
...
def test_response_invalid_argument():
    with pytest.raises(TypeError):
        ngiri.Response(200, content=123)  # type: ignore
