...
def test_response():
    response = ngiri.Response(
        200,
        content=b"Hello, world!",
        request=ngiri.Request("GET", "https://example.org"),
    )
...
def test_response_content():
    response = ngiri.Response(200, content="Hello, world!")
...
def test_response_text():
    response = ngiri.Response(200, text="Hello, world!")
...
def test_response_html():
    response = ngiri.Response(200, html="<html><body>Hello, world!</html></body>")
...
def test_response_json():
    response = ngiri.Response(200, json={"hello": "world"})
...
def test_raise_for_status():
    ...
    response = ngiri.Response(200, request=request)
    response.raise_for_status()

    # 1xx status codes are informational responses.
    response = ngiri.Response(101, request=request)
    ...
    response = ngiri.Response(303, headers=headers, request=request)
    ...
    response = ngiri.Response(403, request=request)
    ...
    response = ngiri.Response(500, request=request)
...
def test_iter_raw_with_chunksize():
    response = ngiri.Response(200, content=streaming_body())
...
def test_iter_raw_doesnt_return_empty_chunks():
    ...
    response = ngiri.Response(200, content=streaming_body_with_empty_chunks())
...
async def test_aiter_raw():
    response = ngiri.Response(200, content=async_streaming_body())
...
def test_iter_bytes():
    response = ngiri.Response(200, content=b"Hello, world!")
...
def test_iter_bytes_with_empty_response():
    response = ngiri.Response(200, content=b"")
...
def test_decode_error_with_request(header_value):
    ...
    with pytest.raises(ngiri.DecodingError):
        ngiri.Response(
            200,
            headers=headers,
    ...
    with pytest.raises(ngiri.DecodingError):
        ngiri.Response(
            ...
            headers=headers,
            content=broken_compressed_body,
            request=ngiri.Request("GET", "https://www.example.org/"),
        )
...
def test_value_error_without_request(header_value):
    ...
    broken_compressed_body = b"xxxxxxxxxxxxxx"
    with pytest.raises(ngiri.DecodingError):
        ngiri.Response(200, headers=headers, content=broken_compressed_body)
...
def test_set_request_after_init():
    ...
    response.request = ngiri.Request("GET", "https://www.example.org")
...
def test_generator_with_transfer_encoding_header():
    ...
    response = ngiri.Response(200, content=content())
...
def test_generator_with_content_length_header():
    ...
    response = ngiri.Response(200, content=content(), headers=headers)
...
async def test_response_async_streaming_picklable():
    response = ngiri.Response(200, content=async_streaming_body())
    pickle_response = pickle.loads(pickle.dumps(response))
    with pytest.raises(ngiri.ResponseNotRead):
...
def test_response_decode_text_using_autodetect():
    ...
    response = ngiri.Response(200, content=content, default_encoding=autodetect)
...
def test_response_decode_text_using_explicit_encoding():
    ...
    response = ngiri.Response(200, content=content, default_encoding="cp1252")
