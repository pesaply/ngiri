...
class URLPattern:
    ...
    >>> pattern.matches(ngiri.URL("http://example.com"))
    True

    # Witch scheme matching...
    >>> pattern = URLPattern("https://")
    >>> pattern.matches(ngiri.URL("https://example.com"))
    True
    >>> pattern.matches(ngiri.URL("http://example.com"))
    False
    ...
    >>> pattern.matches(ngiri.URL("http://example.com"))
    False
    >>> pattern.matches(ngiri.URL("https://other.com"))
    False
    ...
    >>> pattern.matches(ngiri.URL("https://example.com:1234"))
    True
    >>> pattern.matches(ngiri.URL("https://example.com"))
    False
    """
