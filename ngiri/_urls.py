...
class URL:
    """
    url = ngiri.URL("HTTPS://jo%40email.com:a%20secret@müller.de:1234/pa%20th?search=ab#anchorlink")
    ...
    * `url.host` is normalized to always be lowercased. Internationalized domain
      ...
      url = ngiri.URL("http://中国.icom.museum")
      assert url.host == "中国.icom.museum"
      url = ngiri.URL("http://xn--fiqs8s.icom.museum")
      assert url.host == "中国.icom.museum"
    ...
    * `url.port` is either None or an integer. URLs that include the default port for
      ...
      assert ngiri.URL("http://example.com") == ngiri.URL("http://example.com:80")
      assert ngiri.URL("http://example.com").port is None
      assert ngiri.URL("http://example.com:80").port is None
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can
    ...
    def __init__(
        ...
        if isinstance(url, str):
            ...
            raise TypeError(
                "Invalid type for url.  Expected str or ngiri.URL,"
    ...
    def host(self) -> str:
        ...
        url = ngiri.URL("http://www.EXAMPLE.org")
        ...
        url = ngiri.URL("https://[::ffff:192.168.0.1]")
    ...
    def port(self) -> typing.Optional[int]:
        ...
        assert ngiri.URL("http://www.example.com") == ngiri.URL("http://www.example.com:80")
        assert ngiri.URL("http://www.example.com:80").port is None
        """
    ...
    def path(self) -> str:
        ...
        url = ngiri.URL("https://example.com/pa%20th")
        assert url.path == "/pa th"
        """
    ...
    def query(self) -> bytes:
        ...
        url = ngiri.URL("https://example.com/?filter=some%20search%20terms")
    ...
    def raw(self) -> RawURL:
        ...
        In older versions of `ngiri` this was used in the low-level transport API.
    ...
    def copy_with(self, **kwargs: typing.Any) -> "URL":
        ...
        url = ngiri.URL("https://www.example.com").copy_with(
    ...
    def join(self, url: URLTypes) -> "URL":
        ...
        url = ngiri.URL("https://www.example.com/test")
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def keys(self) -> typing.KeysView[str]:
        ...
        q = ngiri.QueryParams("a=123&a=456&b=789")
    ...
    def merge(self, params: typing.Optional[QueryParamTypes] = None) -> "QueryParams":
        ...
        assert q == ngiri.QueryParams("a=456&b=789")
        """
    ...
    def __str__(self) -> str:
        ...
        See https://github.com/encode/ngiri/issues/2536 and
