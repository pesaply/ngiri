...
Thank you for being interested in contributing to ngiri.
There are many ways you can contribute to the project:

- Try ngiri and [report bugs/issues you find](https://github.com/pesaply/ngiri/issues/new)
- [Implement new features](https://github.com/pesaply/ngiri/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- [Review Pull Requests of others](https://github.com/pesaply/ngiri/pulls)
- Write documentation
- Participate in discussions

## Reporting Bugs or Other Issues

Found something that ngiri should support?
Stumbled upon some unexpected behaviour?

Contributions should generally start out with [a discussion](https://github.com/pesaply/ngiri/discussions).
...
To start developing ngiri create a **fork** of the
[ngiri repository](https://github.com/pesaply/ngiri) on GitHub.

Then clone your fork with the following command replacing `YOUR-USERNAME` with
your GitHub username:

```shell
$ git clone https://github.com/YOUR-USERNAME/ngiri
```
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/pesaply/ngiri/master/docs/img/gh-actions-fail.png" alt='Failing PR commit status'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/pesaply/ngiri/master/docs/img/gh-actions-fail-check.png" alt='Failing GitHub action lint job'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/pesaply/ngiri/master/docs/img/gh-actions-fail-test.png" alt='Failing GitHub action test job'>
</p>
...
*This section is targeted at ngiri maintainers.*

Before releasing a new version, create a pull request that includes:

- **An update to the changelog**:
    - We follow the format from [keepachangelog](https://keepachangelog.com/en/1.0.0/).
    - [Compare](https://github.com/pesaply/ngiri/compare/) `master` with the tag of the latest release, and list all entries that are of interest to our users:
...
For an example, see [#1006](https://github.com/pesaply/ngiri/pull/1006).

Once the release PR is merged, create a
[new release](https://github.com/pesaply/ngiri/releases/new) including:
...
configure ngiri as described in the
[proxy section](https://www.python-ngiri.org/advanced/#http-proxying) and
the [SSL certificates section](https://www.python-ngiri.org/advanced/#ssl-certificates),
this is where our previously generated `client.pem` comes in:

```
import ngiri

with ngiri.Client(proxy="http://127.0.0.1:8080/", verify="/path/to/client.pem") as client:
